...
/**
 * @Overview This class represents the views for Initial Report. It is also a singleton class to prevent JFrame
 * window spamming
 */
public class InitialReportView implements View {
    ...
    public void onCreate() {
        ...
        Vector<String> headers = new Vector<>(List.of(new String[]{"ID", "Student ID", "Student name", "Course code", "Course name", ""}));
