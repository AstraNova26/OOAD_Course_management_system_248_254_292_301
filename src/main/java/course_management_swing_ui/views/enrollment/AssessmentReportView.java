...
/**
 * @Overview This class represents the views for Assessment Report. It is also a singleton class to prevent JFrame
 * window spamming
 */
public class AssessmentReportView implements View {
    ...
    public void onCreate() {
        ...
        Vector<String> headers = new Vector<>(List.of(new String[]{"ID", "Student ID", "Course code", "Internal mark", "Exam mark", "Final grade", ""}));
