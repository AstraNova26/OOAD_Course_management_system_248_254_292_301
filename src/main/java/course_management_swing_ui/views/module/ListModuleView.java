...
public class ListModuleView implements View {
    ...
    public void onCreate() {
        ...
        JLabel lblTitle = new JLabel("List of course");
        ...
        Vector<String> headers = new Vector<>(List.of(new String[]{"Code", "Name", "Semester", "Credits", "Course type", "Department", ""}));
