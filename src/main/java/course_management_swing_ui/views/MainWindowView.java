...
public class MainWindowView implements View {
    ...
    public void onCreate() {
        // the window
        gui = new JFrame("Course Management System");
        ...
        JMenu moduleMenu = new JMenu("Course");
        JMenuItem newModule = new JMenuItem("New course");
        newModule.addActionListener(ctrl);
        JMenuItem listModules = new JMenuItem("List course");
        listModules.addActionListener(ctrl);
        moduleMenu.add(newModule);
        moduleMenu.add(listModules);

        JMenu enrolmentMenu = new JMenu("Enrollment");
        ...
        try {
            image = ImageIO.read(new File("src/main/resources/pesu.png"));
        } catch (IOException e) {
