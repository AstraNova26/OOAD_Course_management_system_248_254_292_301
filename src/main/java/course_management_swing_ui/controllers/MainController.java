            ...
            switch (cmd) {
                ...
                case "New student":
                    ...
                    if (addGui == null) {
                        ...
                        //Adds addGui to a map (ViewManager.viewMap) with its hash code as the key.
                        //This likely keeps track of all active views within the application
                    }
                    addGui.display();
                    break;
                case "List students":
